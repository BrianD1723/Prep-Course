...
function diaDeLaSemana(numeroDeDia) {
  ...
  // 2 = Lunes y así sucesivamente. 
  //Realiza una función que dado el número del día de la semana, retorne:
  // "Es fin de semana"
  //si el día corresponde a Sábado o Domingo y “Es dia Laboral” en caso
  // contrario. 
  //Escribe tu código aquí   
...
function todosIguales(arreglo) {
  ...
  //elementos de un arreglo son iguales:
...
function breakStatement(numero) {
  //Iterar en un bucle aumentando en 2 el numero recibido hasta un límite de
  // 10 veces.
